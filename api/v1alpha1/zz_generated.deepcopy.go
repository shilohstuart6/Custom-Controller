...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RequestsAndLimits) DeepCopyInto(out *RequestsAndLimits) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestsAndLimits.
func (in *RequestsAndLimits) DeepCopy() *RequestsAndLimits {
	if in == nil {
		return nil
	}
	out := new(RequestsAndLimits)
	in.DeepCopyInto(out)
	return out
}
